...
/* harmony import */ var _Emoji__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Emoji */ "./components/Emoji.js");
...
var _jsxFileName = "/home/martina/Documents/nakala-threads/frontend/components/Header.js";
...
var Logo = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.h1.withConfig({
  ...
  componentId: "sc-1sgm6xe-0"
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;transform:skew(-7deg);padding-top:1.5rem;padding-bottom:1.2rem;a{padding:0.5rem 1rem;background:", ";border-radius:7px;color:white;text-transform:uppercase;text-decoration:none;:hover{box-shadow:", "}}@media (max-width:1300px){margin:0;text-align:center;}"], function (props) {
...
var StyledHeader = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.header.withConfig({
  ...
  componentId: "sc-1sgm6xe-1"
})([".bar{border-bottom:10px solid ", ";display:grid;grid-template-columns:auto 1fr;justify-content:space-between;align-items:stretch;@media (max-width:1300px){grid-template-columns:1fr;justify-content:center;}h1:hover{box-shadow:", "}}.sub-bar{display:grid;grid-template-columns:1fr auto;border-bottom:1px solid ", ";}"], function (props) {
...
var Header = function Header(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledHeader, {
    ...
    __self: this
  }, "Nakala Store"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Nav__WEBPACK_IMPORTED_MODULE_6__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 75
    },
...
var _jsxFileName = "/home/martina/Documents/nakala-threads/frontend/components/Meta.js";
...
var _jsxFileName = "/home/martina/Documents/nakala-threads/frontend/components/Nav.js";
...
var _jsxFileName = "/home/martina/Documents/nakala-threads/frontend/components/Page.js";
...
var NavStyles = styled_components__WEBPACK_IMPORTED_MODULE_0___default.a.ul.withConfig({
  ...
  componentId: "sc-1e865rj-0"
})(["margin:0;padding:0;display:flex;justify-self:end;font-size:2rem;border-style:None;a,button{padding:1rem 3rem;display:flex;align-items:center;position:relative;text-transform:uppercase;font-weight:900;font-size:1em;background:none;border:0;cursor:pointer;color:", ";font-weight:800;@media (max-width:700px){font-size:10px;padding:0 10px;}&:before{content:'';background:", ";height:100%;left:0;position:absolute;top:0;bottom:0;}&:after{height:2px;background:red;content:'';width:0;position:absolute;transform:translateX(-50%);transition:width 0.4s;transition-timing-function:cubic-bezier(1,-0.65,0,2.31);left:50%;margin-top:2rem;}&:hover,&:focus{outline:none;&:after{width:calc(100% - 60px);}@media (max-width:700px){width:calc(100% - 10px);}}}@media (max-width:1300px){border-top:0px solid ", ";width:100%;justify-content:center;font-size:1.5rem;}"], function (props) {
  return props.theme.black;
}, function (props) {
  return props.theme.lightgrey;
}, function (props) {
...
var _jsxFileName = "/home/martina/Documents/nakala-threads/frontend/pages/_app.js";
  ...
  _createClass(MyApp, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(next_app__WEBPACK_IMPORTED_MODULE_2__["Container"], {
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Component, _extends({}, pgProps, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 24
        },
